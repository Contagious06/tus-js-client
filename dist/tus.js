...
var support = "XMLHttpRequest" in window && "localStorage" in window && "Blob" in window && typeof Blob.prototype.slice === "function";
...
var Upload = (function () {
    ...
    _createClass(Upload, [{
        ...
        key: "_emitSuccess",
        value: function _emitSuccess(xhr) {
